-- Rework by LotharieSlayer
-- better-countdown.lua is just a fork from countdown.lua where hours are deleted because it is not very useful.
-- If you prefer to use the original countdown.lua, just delete this file.
...
function set_time_text()
	...
	local text			= string.format("%02d:%02d", total_minutes, seconds)
